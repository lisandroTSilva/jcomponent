 ...
 * @since  1.6
 */
class EventosViewEvento extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_EVENTOS_TITLE_EVENTO'), 'evento.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_eventos.evento', $this->item->id);
		}
