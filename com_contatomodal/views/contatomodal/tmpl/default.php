...
if (!empty($editor)) {
	JFactory::getDocument()->addScriptOptions('xtd-contatomodal', array('editor' => $editor));
}
?>
<div class="container-popup">
	<form action="<?php echo JRoute::_('index.php?option=com_contatomodal&layout=modal&tmpl=component&function=' . $function . '&' . JSession::getFormToken() . '=1'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
