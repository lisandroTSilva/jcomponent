...
<form
	action="<?php echo JRoute::_('index.php?option=com_inscritos&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="inscritos-form" class="form-validate form-horizontal">
